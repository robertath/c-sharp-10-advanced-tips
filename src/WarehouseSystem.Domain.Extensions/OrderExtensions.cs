...
public static class OrderExtensions
{
    ...
    /// <summary>
    /// Generate Report using Pattern Matching
    /// </summary>
        ...
        (this Order order)
    {
        var status = order switch
        {
            ...
            { Total: >50 and <= 100 and not 75} => "Priority Order Quality",
            
            (var total, true) => $"Order is ready ({total} items)",
